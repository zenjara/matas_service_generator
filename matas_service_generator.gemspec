...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Creates a Service Generator in your lib directory}
  spec.description   = %q{This gem creates a Service Generator file together with template and USAGE inside the lib directory.}
